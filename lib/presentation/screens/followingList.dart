...
class _followingListState extends State<followingList> {
  ...
  Future<void> fetchFollowers(String email) async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/following/$email'));
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage('images/following.jpg'),
                        fit: BoxFit.cover)),
                child: Container(
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Center(
                            child: Text(
                          "Let's see who are you following :)",
                          style: TextStyle(
                              color: Color.fromARGB(255, 55, 164, 241),
                              fontWeight: FontWeight.bold),
                        )),
              ...
              Expanded(
                child: GridView.count(
                  ...
                  mainAxisSpacing: 10,
                  children: _listItem
                      .map((following) => GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => FollowerDetails(
                                    name: following['name'] ?? 'N/A',
                                    email: following['email'] ?? 'N/A',
                                    phone: following['phone'] ?? 'N/A',
                                    image: following['image'] ?? 'N/A',
                                  ),
                                ),
                              );
                            },
