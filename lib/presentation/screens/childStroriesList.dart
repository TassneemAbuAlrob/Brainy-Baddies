...
class childStroriesList extends StatefulWidget {
  final String email;
  ...
  @override
  _childStroriesListState createState() => _childStroriesListState();
}

class _childStroriesListState extends State<childStroriesList> {
  @override
  void initState() {
    super.initState();
    initializeStories();
  ...
  void initializeStories() async {
    ...
    if (userIdFuture != null) {
      await Provider.of<StoryProvider>(context, listen: false)
          .getAllCurrentChildStories(userId: userIdFuture);
    }
  }
                ...
                children: <Widget>[
                  ...
                  Consumer<StoryProvider>(
                    builder: (BuildContext context, StoryProvider storyProvider,
                      ...
                      if (storyProvider.currentUserStories.isEmpty) {
                        return Center(
